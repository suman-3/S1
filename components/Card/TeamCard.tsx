...
const TeamCard = ({
  ...
  return (
    <center
      key={id}
      className="card w-60 bg-base-100 hover:shadow-xl border-[2px] rounded-xl cursor-pointer max-md:w-40 relative overflow-hidden bg-white bg-opacity-20 backdrop-blur-lg"
    >
